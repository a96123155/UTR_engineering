...
nbr_filters = 120
filter_len = 8
#data_file = '../data/PC3_R200bp5UTR_RNA5Ribo0.1.csv'
#data_file = '../data/GSM3130435_egfp_unmod_1.csv'
data_file = '../data/GSM3130442_mcherry_2.csv'
...
df = df.iloc[:200000]
# 若打乱数据 MRL CNN R2会从0.927下降到0.893
#df = df.sample(frac=1)
