...
model = train_model(seq_e_train, e_train['scaled_rl'], nb_epoch=50, border_mode='same',
                   inp_len=seq_length, nodes=120, layers=3, nbr_filters=240, filter_len=12, dropout1=0,
